...
namespace CRUDFABIANTOROEF.Controllers
{
    public class LibroesController : Controller
    {
        ...
        public LibroesController(CrudfabiantoroContext context)
        {
            _context = context;
        }
        ...
        {
            var crudfabiantoroContext = _context.Libros.Include(l => l.CodigoCategoriaNavigation).Include(l => l.NitEditorialNavigation);
