...
namespace CRUDFABIANTOROEF.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public AutorsController(CrudfabiantoroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Idautor,Nombre,Apellido,Pais")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idautor,Nombre,Apellido,Pais")] Autor autor)
        {
            if (id != autor.Idautor)
            {
                return NotFound();
